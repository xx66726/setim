    ...
    <div className="min-h-screen flex flex-col p-4 md:p-6 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-900 dark:to-indigo-950 transition-colors duration-200">
      ...
      {isLoading ? (
        ...
        <div className="max-w-4xl w-full mx-auto grid gap-6 md:grid-cols-1 lg:grid-cols-5">
          {weather && (
            <>
              {/* Weather Card - 2 column span */}
              <div className="lg:col-span-2 bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1">
                <div className="flex justify-between items-center mb-4">
                  <h2 className="text-2xl font-bold text-gray-800 dark:text-white">{weather.location}</h2>
                ...
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <div className="flex items-center p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
                    ...
                    <div>
                      <div className="text-lg font-semibold text-gray-800 dark:text-white">{weather.humidity}%</div>
                  ...
                  <div className="flex items-center p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
                    ...
                    <div>
                      <div className="text-lg font-semibold text-gray-800 dark:text-white">{weather.windSpeed} km/h</div>
              ...
              {/* Recommendations Card - 3 column span */}
              {recommendation && (
                <div className="lg:col-span-3 bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1">
                  <div className="flex justify-between items-center mb-6">
                    <h2 className="text-2xl font-bold text-gray-800 dark:text-white">{t('clothingRecommendations')}</h2>
                    {userData?.style && (
                  ...
                  <div className="space-y-6">
                    {/* Main Outfit Card */}
                    <div className="p-5 bg-gradient-to-r from-indigo-50 to-blue-50 dark:from-indigo-900/20 dark:to-blue-900/20 rounded-xl border-l-4 border-indigo-500 dark:border-indigo-400 animate-fadeIn">
                      <div className="flex items-start">
                        <div className="p-2 bg-white dark:bg-gray-700 rounded-full shadow-sm mr-4">
                          <Shirt size={20} className="text-indigo-600 dark:text-indigo-400" />
                        </div>
                        <div>
                          <h3 className="font-medium text-lg text-indigo-800 dark:text-indigo-300 mb-2">{t('mainOutfit')}</h3>
                    ...
                    {/* Accessories Card */}
                    <div className="p-5 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl border-l-4 border-blue-500 dark:border-blue-400 animate-fadeIn" style={{ animationDelay: "0.1s" }}>
                      <div className="flex items-start">
                        <div className="p-2 bg-white dark:bg-gray-700 rounded-full shadow-sm mr-4">
                          <Umbrella size={20} className="text-blue-600 dark:text-blue-400" />
                        </div>
                        <div>
                          <h3 className="font-medium text-lg text-blue-800 dark:text-blue-300 mb-2">{t('accessories')}</h3>
                    ...
                    {/* Tips Card */}
                    <div className="p-5 bg-gradient-to-r from-amber-50 to-yellow-50 dark:from-amber-900/20 dark:to-yellow-900/20 rounded-xl border-l-4 border-amber-500 dark:border-amber-400 animate-fadeIn" style={{ animationDelay: "0.2s" }}>
                      <div className="flex items-start">
                        <div className="p-2 bg-white dark:bg-gray-700 rounded-full shadow-sm mr-4">
                          <CircleAlert size={20} className="text-amber-600 dark:text-amber-400" />
                        </div>
                        <div>
                          <h3 className="font-medium text-lg text-amber-800 dark:text-amber-300 mb-2">{t('dailyTips')}</h3>
                    ...
                    <div className="text-center pt-2">
                      <div className="inline-flex items-center px-4 py-2 bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-full">
                        <Check size={16} className="mr-2" />
                        <span className="text-sm font-medium">{t('optimalRecommendation')} {weather.temperature}°C</span>
                      </div>
                    </div>
                  </div>
                </div>
